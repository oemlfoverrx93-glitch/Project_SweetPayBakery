...
> Hệ thống quản lý bán bánh trực tuyến — Java Web MVC · SQL Server · Apache Tomcat

---

## 📖 Giới thiệu

**SweetPay Bakery** là ứng dụng web thương mại điện tử dành riêng cho tiệm bánh, được xây dựng theo mô hình **MVC** thuần Java (Servlet + JSP). Hệ thống cho phép khách hàng duyệt sản phẩm, đặt hàng trực tuyến và theo dõi đơn hàng; đồng thời cung cấp bảng điều khiển quản trị đầy đủ cho admin.
...
> ⚠️ Đổi mật khẩu ngay sau khi khởi chạy lần đầu.
...
Dự án được phát triển phục vụ mục đích học tập. © 2026 SweetPay Bakery Team.
